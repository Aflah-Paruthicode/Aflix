...
const FaqAccordion = (props) => {
  ...
  return (
    <div className='relative bg-[#303030] my-2 transition-all duration-500 ease-in-out w-full'>
        <h1 className='cursor-pointer px-[23px] hover:bg-[#434343] transition duration-300 py-6 border-b border-black text-[25px] max-md:text-xl' onClick={handleFaqToggle}>{faq.question}</h1>
