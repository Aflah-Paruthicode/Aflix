  ...
  return (
    <div className="w-full">
      ...
      <div className=" brightness-50 h-[90vh] max-md:h-[100vh] w-full">
        <img className="w-full h-[90vh] max-md:h-screen object-cover object-top" src={LoginPageBgImg} alt="" />
      </div>
      <div className="absolute left-0 right-0 mx-auto top-24 bg-[#000000a6] w-[29rem] max-md:w-[90%] p-16 max-md:py-4 max-md:px-6 rounded-sm">
        ...
        <form onSubmit={(e) => e.preventDefault()}>
          ...
          <input onClick={isValidCredentials} className="bg-red-700 w-full h-10 mb-4 font-semibold text-white rounded-sm" value="Sign In" type="submit" />
        </form>
        <p className="text-[#888888] font-bold text-center mb-4 max-md:hidden">OR</p>
        <input className="bg-[#474747c4] w-full h-10 mb-4 font-semibold text-white rounded-sm max-md:hidden" value="Use a sign-in code" type="submit" />
