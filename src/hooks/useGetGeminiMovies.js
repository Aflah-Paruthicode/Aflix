...
export const useGetGeminiMovies = async (searchText, searchDisabled, setSearchDisabled, dispatch, setErr) => {
  try {
    ...
    let movies = foundMovies.map((resultsList) => resultsList[0]).filter((movie) => movie !== undefined);
